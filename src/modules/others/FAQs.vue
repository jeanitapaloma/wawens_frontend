  ...
  <div class="container">
    ...
    <div class="accordion">
     <b-card no-body class="mb-4" style="border: 2px solid #e5b1fd;" v-for="(item,i) in items" :key="item.message">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle="'accordion-'+ (i +1)" style="border: 2px #e5b1fd;height: 50px;text-align:left;background-color:#e5b1fd; font-size:16px">
