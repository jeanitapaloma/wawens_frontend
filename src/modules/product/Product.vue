<template>
  <div class="container mt-5 pt-5">
    ...
    <b-row>
      <b-col lg="4" v-for="item in products" :key="item">
        <b-card
          id="gallery"
          :img-src="item.image"
          img-alt="Image"
        ...
        >
          <b-link data-toggle="modal" data-target=".bd-example-modal-lg" style="color:#8028d8;">
            <h1 style="font-family:Segoe Script;font-weight:bolder;text-align:left;">{{item.name}}</h1>
          </b-link>
          ...
          <div class="row">
            <div class="col">
              ...
              <h5 style="font-size:20px; text-align:left; margin-left:20px;">
                <strong>Price : &#x20B1; {{item.price}} / {{item.unit}}</strong>
              </h5>
            </div>
            <div class="col">
              ...
              <div class="quantity-toggle" id="app">
                <center>
                  <button @click="decrement(item)">&mdash;</button>
